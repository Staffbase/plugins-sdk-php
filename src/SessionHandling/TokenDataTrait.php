...
/**
 * Trait with the same API as the SessionDataTrait to handle the data
 * of the token
 */
trait TokenDataTrait
{
    ...
    */
    ...
    {
        return isset($this->tokenData[$claim]);
    }
